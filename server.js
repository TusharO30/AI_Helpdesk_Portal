...
// Register a new user
    app.post('/register', async (req, res) => {
        console.log("📬 Someone is trying to register:", req.body.email); // Add this line!
...
app.listen(PORT, () => {
    // We are changing this message so we can PROVE the new code is running!
    console.log(`🚀 Helpdesk Server WITH AUTH ROUTES ACTIVE on http://localhost:${PORT}`);
});